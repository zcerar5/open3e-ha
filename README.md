...
- ViCare/ZigBee current-value DIDs `2086`, `2089`, `2092`, through `2143`, and `2262`, `2265`, through `2319` from the Open3e `BACKENDGATEWAY` device when the payload identifies the slot as a climate sensor
...
- ViCare/ZigBee room-device temperature and humidity sensors from DIDs `2086` to `2319`, filtered to `ViCareDevice.ID == 1`
